...
let%expect_test "realistic: multi-token lexer" =
  ...
  [%expect
    ...
    let rec __sedlex_state_0 buf =
      ...
      | 3 -> (Sedlexing.__private__set_mem buf 1; __sedlex_state_11 buf)
      | 4 -> (Sedlexing.__private__set_mem buf 0; __sedlex_state_14 buf)
    ...
    and __sedlex_state_11 buf =
      ...
      | 1 -> (Sedlexing.__private__set_mem buf 1; __sedlex_state_11 buf)
      | _ -> Sedlexing.backtrack buf
    ...
    and __sedlex_state_14 buf =
      ...
      (match __sedlex_partition_10 (Sedlexing.__private__next_int buf) with
       ...
       | 1 -> (Sedlexing.__private__set_mem buf 0; __sedlex_state_14 buf)
       | _ -> Sedlexing.backtrack buf)
