...
let%expect_test "realistic: multi-token lexer" =
  ...
  [%expect
    ...
    digraph {
      ...
      state0 -> state6 [label="'0' {t19,t15}"];
      state0 -> state7 [label="'1'-'9' {t19,t15}"];
      state0 -> state11 [label="'A'-'Z' {t5}"];
      state0 -> state14 [label="'a'-'z' {t1,t21,t17}"];
      state1 [label="1"];
      ...
      state6 -> state7 [label="'0'-'9' {t19,t15}"];
      state6 -> state8 [label="'x' {t8}"];
      state7 [label="7\n[rule 4]", shape=doublecircle];
      state7 -> state7 [label="'0'-'9' {t19,t15}"];
      state8 [label="8"];
      ...
      state14 -> state14 [label="'a'-'z' {t1,t21,t17}"];
      state15 [label="15"];
    ...
    let rec __sedlex_state_0 buf =
      ...
      | 0 -> (Sedlexing.__private__set_mem buf 10; __sedlex_state_1 buf)
      | 1 ->
          (Sedlexing.__private__set_mem buf 19;
           Sedlexing.__private__set_mem buf 15;
           __sedlex_state_6 buf)
      | 2 ->
          (Sedlexing.__private__set_mem buf 19;
           Sedlexing.__private__set_mem buf 15;
           __sedlex_state_7 buf)
      | 3 -> (Sedlexing.__private__set_mem buf 5; __sedlex_state_11 buf)
      | 4 ->
          (Sedlexing.__private__set_mem buf 1;
           Sedlexing.__private__set_mem buf 21;
           Sedlexing.__private__set_mem buf 17;
    ...
    and __sedlex_state_1 buf =
      ...
      | 0 -> (Sedlexing.__private__set_mem buf 11; __sedlex_state_2 buf)
      | _ -> Sedlexing.backtrack buf
    and __sedlex_state_2 buf =
      match __sedlex_partition_3 (Sedlexing.__private__next_int buf) with
      | 0 -> (Sedlexing.__private__set_mem buf 12; __sedlex_state_3 buf)
      | _ -> Sedlexing.backtrack buf
    and __sedlex_state_3 buf =
      match __sedlex_partition_2 (Sedlexing.__private__next_int buf) with
      | 0 -> (Sedlexing.__private__set_mem buf 13; __sedlex_state_4 buf)
      | _ -> Sedlexing.backtrack buf
      ...
      (match __sedlex_partition_5 (Sedlexing.__private__next_int buf) with
       | 0 ->
           (Sedlexing.__private__set_mem buf 19;
            Sedlexing.__private__set_mem buf 15;
            __sedlex_state_7 buf)
       | 1 -> (Sedlexing.__private__set_mem buf 8; __sedlex_state_8 buf)
       | _ -> Sedlexing.backtrack buf)
    ...
    and __sedlex_state_8 buf =
      ...
      | 0 -> (Sedlexing.__private__set_mem buf 9; __sedlex_state_9 buf)
      | _ -> Sedlexing.backtrack buf
    ...
    and __sedlex_state_11 buf =
      ...
      | 0 -> (Sedlexing.__private__set_mem buf 6; __sedlex_state_12 buf)
      | 1 -> (Sedlexing.__private__set_mem buf 5; __sedlex_state_11 buf)
      | _ -> Sedlexing.backtrack buf
    and __sedlex_state_12 buf =
      match __sedlex_partition_6 (Sedlexing.__private__next_int buf) with
      | 0 -> (Sedlexing.__private__set_mem buf 7; __sedlex_state_13 buf)
      | _ -> Sedlexing.backtrack buf
    ...
    and __sedlex_state_14 buf =
      ...
      (match __sedlex_partition_10 (Sedlexing.__private__next_int buf) with
       | 0 -> (Sedlexing.__private__set_mem buf 2; __sedlex_state_15 buf)
       | 1 ->
           (Sedlexing.__private__set_mem buf 1;
            Sedlexing.__private__set_mem buf 21;
            Sedlexing.__private__set_mem buf 17;
    ...
    and __sedlex_state_15 buf =
      match __sedlex_partition_2 (Sedlexing.__private__next_int buf) with
      | 0 -> (Sedlexing.__private__set_mem buf 3; __sedlex_state_16 buf)
      | _ -> Sedlexing.backtrack buf
    ...
    match Sedlexing.start buf;
          Sedlexing.__private__init_mem buf 22;
          Sedlexing.__private__set_mem buf 16;
          Sedlexing.__private__set_mem buf 20;
          Sedlexing.__private__set_mem buf 14;
          Sedlexing.__private__set_mem buf 18;
    ...
    | 4 ->
        let tok =
          if Sedlexing.__private__mem_is_set buf 19
          then
